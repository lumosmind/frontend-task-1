...
1. [PickBazar Admin REST](https://pickbazar-react-admin-rest.vercel.app)
2. [PickBazar API REST Playground](https://mock.redq.io/docs)
...
# If you want to test your production build admin in local environment then run the below commands.
