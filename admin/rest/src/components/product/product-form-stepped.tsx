...
export default function CreateOrUpdateProductFormStepped({
  initialValues,
  activeStep = 1,
  setActiveStep,
  onCloseModal,
  ...
  const [isSimple, setSimple] = useState<boolean>(true);
  ...
  function goToFirstErrorStep(data: FormValues) {
    ...
    if ("name" in data || "unit" in data) {
      setActiveStep?.(4);
      return;
    }

    if ("price" in data || "quantity" in data || "sku" in data) {
      setActiveStep?.(6);
      return;
    }
  }
  ...
  console.log("productTypeValue?.value", productTypeValue?.value);
  return (
    <>
      {errorMessage ? (
        <Alert
      ...
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(onSubmit, goToFirstErrorStep)} noValidate>
          {/* ----------------- 1 ------------- */}
          <div
          ...
          {/* Simple Type */}
          <div
            style={{ display: activeStep === 6 && isSimple ? "block" : "none" }}
          >
          ...
          {/* <div
            style={{
              display: activeStep === 6 && !isSimple ? "block" : "none",
            }}
          >
            <ProductVariableForm
              shopId={shopId}
          ...
          {/* ----------------- 7 ------------- */}
          {activeStep === 7 && (
            <div className="mb-4 text-center " style={{ paddingTop: "250px" }}>
              {initialValues && (
                <Button
                  variant="outline"
                  onClick={router.back}
